...
export class Record extends Model {
  ...
  public toJsonApi(): JsonApi.IRecord {
    ...
    const useAutogenerated = this.static['useAutogeneratedIds'];

    const data: JsonApi.IRecord = {
      attributes,
      id: (this.__persisted || useAutogenerated) ? this.id : undefined, // TODO: Allow autogenerated IDs in the future
      type: this.type,
    };
